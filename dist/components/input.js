...
export class Input {
    constructor(inputCustomClass, inputLabelText, placeholderText, leadBtnAriaLabel, trailBtnAriaLabel) {
        ...
        const inputLabel = this._inputField.querySelector(".input__label");
        if (!inputLabel) {

...
const openListBtn = document.querySelector(".button--show-recipes");
if (!openListBtn)
    throw new Error("openListBtn not found on page");
const weeklyMenuListWrap = document.querySelector(".weekly-list__wrap");
